...
two_two_four = NaryCSP({'T': set(range(1, 10)), 'F': set(range(1, 10)),
                       ...
                       [Constraint(('T', 'F', 'W', 'O', 'U', 'R'), all_diff_constraint),
                        ...
                        Constraint(('W', 'U', 'C1', 'C2'), lambda w, u,
                                   c1, c2: c1 + w + w == u + 10 * c2),
                        Constraint(('T', 'O', 'C2', 'C3'), lambda t, o,
                                   c2, c3: c2 + t + t == o + 10 * c3),
                        Constraint(('F', 'C3'), eq)])
...
send_more_money = NaryCSP({'S': set(range(1, 10)), 'M': set(range(1, 10)),
                          ...
                          [Constraint(('S', 'E', 'N', 'D', 'M', 'O', 'R', 'Y'), all_diff_constraint),
                           Constraint(('D', 'E', 'Y', 'C1'), lambda d,
                                      e, y, c1: d + e == y + 10 * c1),
                           Constraint(('N', 'R', 'E', 'C1', 'C2'), lambda n,
                                      r, e, c1, c2: c1 + n + r == e + 10 * c2),
                           Constraint(('E', 'O', 'N', 'C2', 'C3'), lambda e,
                                      o, n, c2, c3: c2 + e + o == n + 10 * c3),
                           Constraint(('S', 'M', 'O', 'C3', 'C4'), lambda s,
                                      m, o, c3, c4: c3 + s + m == o + 10 * c4),
                           Constraint(('M', 'C4'), eq)])
